    ...
    <div class="pnlPageContent scrollBar">
      ...
      <div class="systemsPage">
        ...
        <div class="logArea">
          <div class="logMsg">
            {{
              CurrentType == 'System' ? $t('SURREALM.Systems.LogContent') : $t('SURREALM.Systems.ClientLectureContent')
            }}
          </div>
...
import { apiGetPostStudent, apiUpdatePostRead } from '@/request.js';
...
export default {
  ...
  methods: {
    GetLogs() {
      apiGetPostStudent(this.CurrentType).then((res) => {
    ...
    MsgKeyToValue(Key) {
      return this.CurrentType == 'System' ? this.$t('SURREALM.Systems.Student.' + Key) : Key;
    },
    ShowMsgDetail(log) {
