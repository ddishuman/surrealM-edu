...
const apiServer = "http://54.95.227.250:5600/";
...
export const apiTeacherGetBonusRecord = apiServer + "bonus/";
...
export const apiGetCourseFrame = (serial) => modelRequest.get('/frames/course/' + serial, {
    headers: {
        accessToken: Vue.prototype.TokenDecode(localStorage.getItem('Token'))
    },
})

export const apiEditCourseFrame = (serial, data) => modelRequest.put('/frame/course/' + serial + "/edit", data, {
    headers: {
        accessToken: Vue.prototype.TokenDecode(localStorage.getItem('Token'))
    },
})
...
export const apiGetNewLectureStudent = (serial, date, starttime, endtime) => modelRequest.get(`/newlecturestudent/${serial}/${date}/${starttime}/${endtime}`, {
    headers: {
        accessToken: Vue.prototype.TokenDecode(localStorage.getItem('Token'))
    },
})
